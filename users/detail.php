...
$users=query($pdo,'SELECT * FROM user WHERE user.userID=?',[$_GET['id']]);
$users=$users->fetch();
$posts=query($pdo,'SELECT comment.userID, comment.description, comment.commentID, user.name FROM comment JOIN user ON user.userID=comment.userID WHERE user.userID=?',[$_GET['id']])
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
						...
						<ul>
							...
							<li><span><a href="#0"><?php echo "Pages";?></a></span>
								<ul>
									...
									<li><a href="../comments/index.php"><?php echo "Posts";?></a></li>
	...
	<main>
		...
		<h4 data-bs-target="#collapse_ft_1"><a href="index.php" ><?php echo "See All Users";?></a></h4>
			<div class="box_booking">
				<div class="strip_booking">
					<div class="row">
						<div class="col-lg-9 col-md-5">
							<h2><?php echo $users['userID'];?></h2>
				...
				<h4 data-bs-target="#collapse_ft_1"><?php echo "Posts by ".$users['name'];?></h4>
				<?php
					...
					<div class="strip_booking">
						<div class="row">
							<div class="col-lg-8 col-md-5">
								<h3><a href="../comments/detail.php?id=<?=$post['commentID']?>"><?php echo $post['commentID'];?></h3>
