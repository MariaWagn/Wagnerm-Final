  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><?php echo "Users List" ;?></li>
      </ol>
		<div class="box_general">
			<div class="header_box">
				<h2 class="d-inline-block"><?php echo "Users List" ;?></h2>
			</div>
			<div class="list_general">
				...
				while(!feof($fp)){
					...
					if(strlen($line)>0){
						...
						?>
						<li>
							<h4><?php echo $line[0];?></h4>
							<ul class="booking_list">
								<li><strong><?php echo "Password" ;?></strong><?php echo $line[1];?></li>
							</ul>
							<ul class="buttons">
								<li><a href="detail-user.php?index=<?php echo $index ;?>" class="btn_1 gray approve"><?php echo "Details";?></a></li>
							</ul>
						</li>
					<?php
					}
