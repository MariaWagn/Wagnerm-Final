					...
					if($_GET['index']==$index){
						if(strlen($line)>0){
							...
							<li>
								...
								<ul class="buttons">
									<li><a href="edit-user.php?index=<?php echo $index ;?>" class="btn_1 gray approve"><?php echo "Edit User";?></a></li>
									<li><a href="delete.php?index=<?php echo $index ;?>" class="btn_1 gray approve"><?php echo "Delete User";?></a></li>
								</ul>
							</li>
						<?php
						}
