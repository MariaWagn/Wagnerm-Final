				  ...
				  <div class="content-wrapper">
					<div class="container-fluid">
					  ...
					  <ol class="breadcrumb">
						...
						<li class="breadcrumb-item">
						  <a href="detail-genre.php?index=<?=$_GET['index']?>"><?php echo "Genre";?></a>
						</li>
						<li class="breadcrumb-item active"><?php echo "Edit Genre" ;?></li>
					  </ol>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<textarea name="img" class="form-control"><?= $item['img'] ?></textarea>
									</div>
								</div>
							</div>
							<!-- /row-->
