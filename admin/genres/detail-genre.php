  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
		...
		<li class="breadcrumb-item">
          <a href="index.php"><?php echo "Genres List" ;?></a>
        </li>
        <li class="breadcrumb-item active"><?php echo "Genre" ;?></li>
      </ol>
				...
				<ul>
					<li>
						...
						<ul class="booking_list">
							<li><strong><?php echo "Book Amount" ;?></strong><?= $item['amount'] ?></li>
							<li><strong><?php echo "Image" ;?></strong><?= $item['img'] ?></li>
						</ul>
						<ul class="buttons">
							<li><a href="edit-genre.php?index=<?=$_GET['index']?>" class="btn_1 gray approve"><?php echo "Edit Genre";?></a></li>
							<li><a href="delete.php?index=<?=$_GET['index']?>" class="btn_1 gray approve"><?php echo "Delete Genre";?></a></li>
						</ul>
					</li>	
				</ul>
			</div>
