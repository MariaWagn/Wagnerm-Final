...
$posts=query($pdo,'SELECT comment.userID, comment.description, comment.commentID, user.name FROM comment JOIN user ON user.userID=comment.userID WHERE comment.commentID=?',[$_GET['id']]);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
	...
	<main>
		...
		<h4 data-bs-target="#collapse_ft_1"><a href="index.php" ><?php echo "See All Posts";?></a></h4>
